...
source("scripts/genResultsDEF1bef100_new_frailty.R")  # FRAILTY
#source("scripts/genResultsDEF2bef100_new.R")  # GAP TIME
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=730, old=730, 
                 d.ev=d.ev4, d.cens=d.cens4, b0.ev=b0.ev4, b0.cens=b0.cens4,
                 a.ev=a.ev4, a.cens=a.cens4, m=5)
WriteXLS(results, "results/SJWEH/res1115.xls")
...
res1115.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res1115.ag, "results/SJWEH/results1115.xls")



results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=1825, old=730, 
                 d.ev=d.ev4, d.cens=d.cens4, b0.ev=b0.ev4, b0.cens=b0.cens4,
                 a.ev=a.ev4, a.cens=a.cens4, m=5)
WriteXLS(results, "results/SJWEH/res1125.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res1125.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res1125.ag, "results/SJWEH/results1125.xls")



results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=730, old=3650, 
                 d.ev=d.ev4, d.cens=d.cens4, b0.ev=b0.ev4, b0.cens=b0.cens4,
                 a.ev=a.ev4, a.cens=a.cens4, m=5)
WriteXLS(results, "results/SJWEH/res1215.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res1215.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res1215.ag, "results/SJWEH/results1215.xls")


results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=1825, old=3650, 
                 d.ev=d.ev4, d.cens=d.cens4, b0.ev=b0.ev4, b0.cens=b0.cens4,
                 a.ev=a.ev4, a.cens=a.cens4, m=5)
WriteXLS(results, "results/SJWEH/res1225.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res1225.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res1225.ag, "results/SJWEH/results1225.xls")
...
WriteXLS(results, "results/SJWEH/res2115.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res2115.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res2115.ag, "results/SJWEH/results2115.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=1825, old=730, 
                 d.ev=d.ev5, d.cens=d.cens5, b0.ev=b0.ev5, b0.cens=b0.cens5,
                 a.ev=a.ev5, a.cens=a.cens5, m=5)
WriteXLS(results, "results/SJWEH/res2125.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res2125.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res2125.ag, "results/SJWEH/results2125.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=730, old=3650, 
                 d.ev=d.ev5, d.cens=d.cens5, b0.ev=b0.ev5, b0.cens=b0.cens5,
                 a.ev=a.ev5, a.cens=a.cens5, m=5)
WriteXLS(results, "results/SJWEH/res2215.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res2215.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res2215.ag, "results/SJWEH/results2215.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=1825, old=3650, 
                 d.ev=d.ev5, d.cens=d.cens5, b0.ev=b0.ev5, b0.cens=b0.cens5,
                 a.ev=a.ev5, a.cens=a.cens5, m=5)
WriteXLS(results, "results/SJWEH/res2225.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res2225.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res2225.ag, "results/SJWEH/results2225.xls")
...
WriteXLS(results, "results/SJWEH/res3115.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res3115.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res3115.ag, "results/SJWEH/results3115.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=1825, old=730, 
                 d.ev=d.ev6, d.cens=d.cens6, b0.ev=b0.ev6, b0.cens=b0.cens6,
                 a.ev=a.ev6, a.cens=a.cens6, m=5)
WriteXLS(results, "results/SJWEH/res3125.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res3125.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res3125.ag, "results/SJWEH/results3125.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=730, old=3650, 
                 d.ev=d.ev6, d.cens=d.cens6, b0.ev=b0.ev6, b0.cens=b0.cens6,
                 a.ev=a.ev6, a.cens=a.cens6, m=5)
WriteXLS(results, "results/SJWEH/res3215.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res3215.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res3215.ag, "results/SJWEH/results3215.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=1000, bef=1, ft=1825, old=3650, 
                 d.ev=d.ev6, d.cens=d.cens6, b0.ev=b0.ev6, b0.cens=b0.cens6,
                 a.ev=a.ev6, a.cens=a.cens6, m=5)
WriteXLS(results, "results/SJWEH/res3225.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
res3225.ag <- data.frame(c0,c1,c2,c3,bias25,bias50,bias75, LPIx, LPIx1, LPIx2, cov.x, cov.x1, cov.x2, mean.bias, mean.LPI, mean.cob)
WriteXLS(res3225.ag, "results/SJWEH/results3225.xls")
