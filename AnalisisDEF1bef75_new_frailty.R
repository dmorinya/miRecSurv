...
WriteXLS(results, "results/Gaceta/res1114.xls")
...
WriteXLS(res1114.ag, "results/Gaceta/results1114.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=1825, old=730, 
                 d.ev=d.ev1, d.cens=d.cens1, b0.ev=b0.ev1, b0.cens=b0.cens1,
                 a.ev=a.ev1, a.cens=a.cens1, m=5)
WriteXLS(results, "results/Gaceta/res1124.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res1124.ag, "results/Gaceta/results1124.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=730, old=3650, 
                 d.ev=d.ev1, d.cens=d.cens1, b0.ev=b0.ev1, b0.cens=b0.cens1,
                 a.ev=a.ev1, a.cens=a.cens1, m=5)
WriteXLS(results, "results/Gaceta/res1214.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res1214.ag, "results/Gaceta/results1214.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=1825, old=3650, 
                 d.ev=d.ev1, d.cens=d.cens1, b0.ev=b0.ev1, b0.cens=b0.cens1,
                 a.ev=a.ev1, a.cens=a.cens1, m=5)
WriteXLS(results, "results/Gaceta/res1224.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res1224.ag, "results/Gaceta/results1224.xls")
...
WriteXLS(results, "results/Gaceta/res2114.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2114.ag, "results/Gaceta/results2114.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=1825, old=730, 
                     d.ev=d.ev2, d.cens=d.cens2, b0.ev=b0.ev2, b0.cens=b0.cens2,
                     a.ev=a.ev2, a.cens=a.cens2, m=5)
WriteXLS(results, "results/Gaceta/res2124.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2124.ag, "results/Gaceta/results2124.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=730, old=3650, 
                     d.ev=d.ev2, d.cens=d.cens2, b0.ev=b0.ev2, b0.cens=b0.cens2,
                     a.ev=a.ev2, a.cens=a.cens2, m=5)
WriteXLS(results, "results/Gaceta/res2214.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2214.ag, "results/Gaceta/results2214.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=1825, old=3650, 
                     d.ev=d.ev2, d.cens=d.cens2, b0.ev=b0.ev2, b0.cens=b0.cens2,
                     a.ev=a.ev2, a.cens=a.cens2, m=5)
WriteXLS(results, "results/Gaceta/res2224.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2224.ag, "results/Gaceta/results2224.xls")
...
WriteXLS(results, "results/Gaceta/res3114.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3114.ag, "results/Gaceta/results3114.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=1825, old=730, 
                     d.ev=d.ev3, d.cens=d.cens3, b0.ev=b0.ev3, b0.cens=b0.cens3,
                     a.ev=a.ev3, a.cens=a.cens3, m=5)
WriteXLS(results, "results/Gaceta/res3124.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3124.ag, "results/Gaceta/results3124.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=730, old=3650, 
                     d.ev=d.ev3, d.cens=d.cens3, b0.ev=b0.ev3, b0.cens=b0.cens3,
                     a.ev=a.ev3, a.cens=a.cens3, m=5)
WriteXLS(results, "results/Gaceta/res3214.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3214.ag, "results/Gaceta/results3214.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1_new_frailty(k, nm=250, bef=.75, ft=1825, old=3650, 
                     d.ev=d.ev3, d.cens=d.cens3, b0.ev=b0.ev3, b0.cens=b0.cens3,
                     a.ev=a.ev3, a.cens=a.cens3, m=5)
WriteXLS(results, "results/Gaceta/res3224.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3224.ag, "results/Gaceta/results3224.xls")