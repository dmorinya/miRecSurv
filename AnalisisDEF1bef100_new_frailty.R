...
WriteXLS(results, "results/Gaceta/res1115.xls")
...
WriteXLS(res1115.ag, "results/Gaceta/results1115.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=1825, old=730, 
                 d.ev=d.ev1, d.cens=d.cens1, b0.ev=b0.ev1, b0.cens=b0.cens1,
                 a.ev=a.ev1, a.cens=a.cens1, m=5)
WriteXLS(results, "results/Gaceta/res1125.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res1125.ag, "results/Gaceta/results1125.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=730, old=3650, 
                 d.ev=d.ev1, d.cens=d.cens1, b0.ev=b0.ev1, b0.cens=b0.cens1,
                 a.ev=a.ev1, a.cens=a.cens1, m=5)
WriteXLS(results, "results/Gaceta/res1215.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res1215.ag, "results/Gaceta/results1215.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=1825, old=3650, 
                 d.ev=d.ev1, d.cens=d.cens1, b0.ev=b0.ev1, b0.cens=b0.cens1,
                 a.ev=a.ev1, a.cens=a.cens1, m=5)
WriteXLS(results, "results/Gaceta/res1225.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res1225.ag, "results/Gaceta/results1225.xls")
...
WriteXLS(results, "results/Gaceta/res2115.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2115.ag, "results/Gaceta/results2115.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=1825, old=730, 
                 d.ev=d.ev2, d.cens=d.cens2, b0.ev=b0.ev2, b0.cens=b0.cens2,
                 a.ev=a.ev2, a.cens=a.cens2, m=5)
WriteXLS(results, "results/Gaceta/res2125.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2125.ag, "results/Gaceta/results2125.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=730, old=3650, 
                 d.ev=d.ev2, d.cens=d.cens2, b0.ev=b0.ev2, b0.cens=b0.cens2,
                 a.ev=a.ev2, a.cens=a.cens2, m=5)
WriteXLS(results, "results/Gaceta/res2215.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2215.ag, "results/Gaceta/results2215.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=1825, old=3650, 
                 d.ev=d.ev2, d.cens=d.cens2, b0.ev=b0.ev2, b0.cens=b0.cens2,
                 a.ev=a.ev2, a.cens=a.cens2, m=5)
WriteXLS(results, "results/Gaceta/res2225.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res2225.ag, "results/Gaceta/results2225.xls")
...
WriteXLS(results, "results/Gaceta/res3115.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3115.ag, "results/Gaceta/results3115.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=1825, old=730, 
                 d.ev=d.ev3, d.cens=d.cens3, b0.ev=b0.ev3, b0.cens=b0.cens3,
                 a.ev=a.ev3, a.cens=a.cens3, m=5)
WriteXLS(results, "results/Gaceta/res3125.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3125.ag, "results/Gaceta/results3125.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=730, old=3650, 
                 d.ev=d.ev3, d.cens=d.cens3, b0.ev=b0.ev3, b0.cens=b0.cens3,
                 a.ev=a.ev3, a.cens=a.cens3, m=5)
WriteXLS(results, "results/Gaceta/res3215.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3215.ag, "results/Gaceta/results3215.xls")
...
results <- foreach(k=1:nsim, .combine=rbind) %dopar% 
  genResultsDEF1bef100_new_frailty(k, nm=250, bef=1, ft=1825, old=3650, 
                 d.ev=d.ev3, d.cens=d.cens3, b0.ev=b0.ev3, b0.cens=b0.cens3,
                 a.ev=a.ev3, a.cens=a.cens3, m=5)
WriteXLS(results, "results/Gaceta/res3225.xls")
c0 <- rbind("AG F", "ComP (CP) F", "ComP (GT) F")
c1 <- rbind(AG=mean(results$gcoefAG.x), COMPois=mean(results$gcoefCOMPois.x), COMPoisB=mean(results$gcoefCOMPoisB.x))
c2 <- rbind(AG=mean(results$gcoefAG.x1), COMPois=mean(results$gcoefCOMPois.x1), COMPoisB=mean(results$gcoefCOMPoisB.x1))
c3 <- rbind(AG=mean(results$gcoefAG.x2), COMPois=mean(results$gcoefCOMPois.x2), COMPoisB=mean(results$gcoefCOMPoisB.x2))
...
WriteXLS(res3225.ag, "results/Gaceta/results3225.xls")
